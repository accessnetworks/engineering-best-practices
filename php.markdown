...
**This is a slightly modifed version from [10UP](https://10up.github.io/Engineering-Best-Practices/php)**
...
When we works on more than one project for a client and we build common plugins shared between sites, "Common" might be used in place of the project name to signal this code's relationship to the rest of the codebase.
...
// WP VIP prefer to escape right at the point of output, which would be here
echo <<<HTML
